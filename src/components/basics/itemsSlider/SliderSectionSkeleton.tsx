  ...
  return (
    <section className="w-full py-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="px-4 sm:px-6 mb-4 animate-pulse">
          {/* Placeholder para el Título */}
          <div className="h-8 w-1/3 bg-skeleton rounded"></div>
        </div>

        {/* Carrusel de tarjetas esqueléticas */}
        <div className="flex gap-4 overflow-hidden pb-4 px-4 sm:px-6">
        ...
        <div className="mt-1 px-4 sm:px-6 animate-pulse">
